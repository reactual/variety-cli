...
var options = [
  ...
  opt('dropdownFields', 'Specify fields that you would like an array of all values from collection - mongoDB distinct() will be ran', function(val) {return val.split(',');})
];
